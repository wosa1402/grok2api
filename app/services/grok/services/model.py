...
class ModelService:
    ...
    MODELS = [
        ...
        ModelInfo(
            model_id="grok-3-mini-deepsearch",
            grok_model="grok-3",
            model_mode="MODEL_MODE_GROK_3_MINI_THINKING",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-3-MINI-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-3-thinking-deepsearch",
            grok_model="grok-3",
            model_mode="MODEL_MODE_GROK_3_THINKING",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-3-THINKING-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-4-deepsearch",
            grok_model="grok-4",
            model_mode="MODEL_MODE_GROK_4",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-4-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            ...
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-4-THINKING-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-4-heavy-deepsearch",
            grok_model="grok-4",
            model_mode="MODEL_MODE_HEAVY",
            tier=Tier.SUPER,
            cost=Cost.HIGH,
            display_name="GROK-4-HEAVY-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-4.1-mini-deepsearch",
            grok_model="grok-4-1-thinking-1129",
            model_mode="MODEL_MODE_GROK_4_1_MINI_THINKING",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-4.1-MINI-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-4.1-fast-deepsearch",
            grok_model="grok-4-1-thinking-1129",
            model_mode="MODEL_MODE_FAST",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-4.1-FAST-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-4.1-expert-deepsearch",
            grok_model="grok-4-1-thinking-1129",
            model_mode="MODEL_MODE_EXPERT",
            tier=Tier.BASIC,
            cost=Cost.HIGH,
            display_name="GROK-4.1-EXPERT-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
        ...
        ModelInfo(
            model_id="grok-4.1-thinking-deepsearch",
            grok_model="grok-4-1-thinking-1129",
            model_mode="MODEL_MODE_GROK_4_1_THINKING",
            tier=Tier.BASIC,
            cost=Cost.HIGH,
            display_name="GROK-4.1-THINKING-DEEPSEARCH",
            is_image=False,
            is_image_edit=False,
            is_video=False,
            is_deepsearch=True,
